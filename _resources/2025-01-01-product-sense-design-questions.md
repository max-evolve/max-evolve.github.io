...
4. **Pain points / opportunities to be defined for the selected user segment** — what are some areas of difficulty for the user segment? 
...
6. **Solution prioritisation** according to the the highest return on investment (ROI) where ROI is measured through:
...
- [Cracking Product Sense Interviews](https://www.youtube.com/watch?v=JgEBQTXRXiQ&ab_channel=pmcurvebyDeepakSingh)
...
- [Product Sense Case Studies](https://docs.google.com/presentation/d/1V7RNQ4opUVz9trlSNzit7_0hU1x4ajPqG7STZYo8wTM/edit?slide=id.p#slide=id.p)
- [Thought framework for Senior PMs](https://blog.tryexponent.com/senior-pm-interview-questions-structure/)